...
def compute_and_export_sensitivity_algo_Saltelli(
    ...
    """
    complete_pkl_filename_metamodel = miu.create_pkl_name(type_of_metamodel + '_mechanoadaptation_vs_passive_elliptic', training_amount)
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(
        type_of_metamodel + '_mechanoadaptation_vs_passive_elliptic', training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    )
...
def compute_and_export_sensitivity_algo_Jansen(
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(type_of_metamodel + '_mechanoadaptation_vs_passive_elliptic'
...
def compute_convergence_Sobol_indices(
    ...
    Saltelli_first_order_indices_confidence_errorbars_vs_experiment_size = np.zeros((2, 6, len(sensitivity_experiment_size_list)))
...
def compute_sensitivity_indices_PCE(training_amount, degree):
    ...
    complete_filename = miu.create_pkl_name("PCE_mechanoadaptation_vs_passive_elliptic" + str(degree), training_amount, folder="")
    ...
    first_order_indices = [chaosSI.getSobolIndex(k) for k in range(6)]
    total_order_indices = [chaosSI.getSobolTotalIndex(k) for k in range(6)]
...
def plot_results_sensitivity_analysis(
    ...
    ax.set_xticklabels(
        [r"$\overline{\gamma}_0$", r"$\overline{\sigma}$", r"$\overline{\gamma}_A$", r"$\overline{\gamma}_D$", r"$\overline{\gamma}_S$", r"$\overline{r}$"],
        font=fonts.serif(),
    ...
    filename = (
        ...
        + "_metamodel="
        + type_of_metamodel
        + "_mechanoadaptation_vs_passive_elliptic_trainingamount="
        + str(training_amount)
        + "_size="
...
computation_time_vs_experiment_size,     createfigure,
    ...
    labels = [r"$\overline{\gamma}_0$", r"$\overline{\sigma}$", r"$\overline{\gamma}_A$", r"$\overline{\gamma}_D$", r"$\overline{\gamma}_S$", r"$\overline{r}$"]
    ...
    savefigure.save_as_png(fig_first, 'convergence_firstSobol_mechanoadaptation_vs_passive_elliptic_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
    savefigure.save_as_png(fig_total, 'convergence_totalSobol_mechanoadaptation_vs_passive_elliptic_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
...
def plot_confinterval_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_confinterval = "sensitivity_analysis_convergence_confinterval_mechanoadaptation_vs_passive_elliptic.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "confinterval_firstSobol_Saltelli_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "confinterval_totalSobol_Saltelli_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_first, "confinterval_firstSobol_Jansen_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_total, "confinterval_totalSobol_Jansen_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "confinterval_firstSobol_MauntzKucherenko_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "confinterval_totalSobol_MauntzKucherenko_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_first, "confinterval_firstSobol_Martinez_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_total, "confinterval_totalSobol_Martinez_mechanoadaptation_vs_passive_elliptic")
...
def plot_gradient_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_gradient = "sensitivity_analysis_convergence_gradient_mechanoadaptation_vs_passive_elliptic.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "gradient_firstSobol_Saltelli_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "gradient_totalSobol_Saltelli_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_first, "gradient_firstSobol_Jansen_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_total, "gradient_totalSobol_Jansen_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "gradient_firstSobol_MauntzKucherenko_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "gradient_totalSobol_MauntzKucherenko_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_first, "gradient_firstSobol_Martinez_mechanoadaptation_vs_passive_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_total, "gradient_totalSobol_Martinez_mechanoadaptation_vs_passive_elliptic")
...
def plot_comparison_indices_piechart(
    ...
    filename = ('sobolindices_Kriging_piechart_mechanoadaptation_vs_passive_elliptic')
    savefigure.save_as_png(fig, filename + str(pixels) + "p")
...
if __name__ == "__main__":
    ...
    filename_sensitivity_convergence = "sensitivity_analysis_convergence_mechanoadaptation_vs_passive_elliptic.pkl"
