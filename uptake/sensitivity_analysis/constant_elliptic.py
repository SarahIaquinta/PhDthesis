...
def compute_and_export_sensitivity_algo_Saltelli(
    ...
    """
    complete_pkl_filename_metamodel = miu.create_pkl_name(type_of_metamodel + '_constant_elliptic', training_amount)
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(
        type_of_metamodel + '_constant_elliptic', training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    )
...
def get_indices_and_confidence_intervals(type_of_metamodel, training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(type_of_metamodel + '_constant_elliptic'
...
def compute_convergence_Sobol_indices(
    ...
    miu.export_utils_sensitivity_convergence_confinterval("sensitivity_analysis_convergence_confinterval_constant_elliptic.pkl", Saltelli_first_order_indices_vs_experiment_size_confinterval,Saltelli_total_order_indices_vs_experiment_size_confinterval,Jansen_first_order_indices_vs_experiment_size_confinterval,Jansen_total_order_indices_vs_experiment_size_confinterval,MauntzKucherenko_first_order_indices_vs_experiment_size_confinterval,MauntzKucherenko_total_order_indices_vs_experiment_size_confinterval,Martinez_first_order_indices_vs_experiment_size_confinterval,Martinez_total_order_indices_vs_experiment_size_confinterval)
...
def compute_sensitivity_indices_PCE(training_amount, degree):
    ...
    total_order_indices: list
        ...
        gamma_bar_r, gamma_bar_fs, gamma_bar_lambda
    """
    complete_filename = miu.create_pkl_name("PCE_constant_elliptic" + str(degree), training_amount, folder="")
...
def plot_results_sensitivity_analysis(
    ...
    sensitivity_algo = miu.extract_sensitivity_algo_from_pkl(complete_pkl_filename_sensitivy_algo)
    first_order_indices = sensitivity_algo.getFirstOrderIndices()
    conf = sensitivity_algo.getConfidenceLevel()
    print(conf)
    first_order_indices_confidence_interval = sensitivity_algo.getFirstOrderIndicesInterval()
    first_order_indices_confidence_lowerbounds = [
        first_order_indices_confidence_interval.getLowerBound()[k] for k in [0, 1, 2]
    ...
    ax.set_xticks([0, 1, 2])
    ax.set_xticklabels(
        [r"$\overline{\gamma}$", r"$\overline{\sigma}$", r"$\overline{r}$"],
        font=fonts.serif(),
    ...
    filename = (
        ...
        + "_metamodel="
        + type_of_metamodel
        + "contant_elliptic_trainingamount="
        + str(training_amount)
        + "_size="
...
computation_time_vs_experiment_size,     createfigure,
    ...
    labels = [r"$\overline{\gamma}$", r"$\overline{\sigma}$", r"$\overline{r}$"]
    palette = sns.color_palette("Paired")
    # palette = sns.color_palette("husl", 6)

    # errorbar_colors = [palette[k] for k in range(0, len(palette), 2)]
    line_colors = [palette[1], palette[3], palette[-1]]
    ...
    savefigure.save_as_png(fig_first, 'convergence_firstSobol_constant_elliptic_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
    savefigure.save_as_png(fig_total, 'convergence_totalSobol_constant_elliptic_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
...
def plot_confinterval_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_confinterval = "sensitivity_analysis_convergence_confinterval_constant_elliptic.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "confinterval_firstSobol_Saltelli_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "confinterval_totalSobol_Saltelli_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_first, "confinterval_firstSobol_Jansen_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_total, "confinterval_totalSobol_Jansen_constant_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "confinterval_firstSobol_MauntzKucherenko_constant_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "confinterval_totalSobol_MauntzKucherenko_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_first, "confinterval_firstSobol_Martinez_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_total, "confinterval_totalSobol_Martinez_constant_elliptic")
...
def plot_gradient_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_gradient = "sensitivity_analysis_convergence_gradient_constant_elliptic.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "gradient_firstSobol_Saltelli_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "gradient_totalSobol_Saltelli_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_first, "gradient_firstSobol_Jansen_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Jansen_total, "gradient_totalSobol_Jansen_constant_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "gradient_firstSobol_MauntzKucherenko_constant_elliptic")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "gradient_totalSobol_MauntzKucherenko_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_first, "gradient_firstSobol_Martinez_constant_elliptic")
    ...
    savefigure.save_as_png(fig_Martinez_total, "gradient_totalSobol_Martinez_constant_elliptic")
...
def plot_comparison_indices(
    ...
    filename = (
        ...
        + "_constant_elliptic_trainingamount="
        + str(training_amount)
        + "_size="
        + str(sensitivity_experiment_size)
        + "_"
...
def plot_comparison_indices_piechart(
    ...
    palette = sns.color_palette("Paired")
    colors = (palette[1], palette[3], palette[-1])
    labels = [r"$\overline{\gamma}_0$", r"$\overline{\sigma}$", r"$\overline{r}$"]
    fig = createfigure.square_figure_7(pixels=pixels)
    ax = fig.gca()
    ...
    filename = ('sobolindices_Kriging_piechart_constant_elliptic')
    savefigure.save_as_png(fig, filename + str(pixels) + "p")
