    ...
    def composed(self):
        ...
        Returns:
            ...
            distribution: ot class
                ...
                gamma_bar_lambda and sigma_bar_lambda could have been computed as mechanoadaptation values
...
def compute_and_export_sensitivity_algo_Saltelli(
    ...
    """
    complete_pkl_filename_metamodel = miu.create_pkl_name(type_of_metamodel + '_mechanoadaptation_circular', training_amount)
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(
        type_of_metamodel + '_mechanoadaptation_circular', training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    )
...
def compute_and_export_sensitivity_algo_Jansen(
    ...
    complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(type_of_metamodel + '_mechanoadaptation_circular'
...
def gradient(vector):
    ...
    for k in range(nb_samples-1):
        gradient[0, k] = np.abs(np.diff(vector)[k])/ np.abs(vector[k])
    return gradient
...
def compute_convergence_Sobol_indices(
    ...
    Saltelli_first_order_indices_vs_experiment_size = np.zeros((3, len(sensitivity_experiment_size_list)))
    Saltelli_total_order_indices_vs_experiment_size = np.zeros_like(Saltelli_first_order_indices_vs_experiment_size)
    Saltelli_first_order_indices_confidence_errorbars_vs_experiment_size = np.zeros((2, 3, len(sensitivity_experiment_size_list)))
    ...
    miu.export_utils_sensitivity_convergence_confinterval("sensitivity_analysis_convergence_confinterval_mechanoadaptation_circular.pkl", Saltelli_first_order_indices_vs_experiment_size_confinterval,Saltelli_total_order_indices_vs_experiment_size_confinterval,Jansen_first_order_indices_vs_experiment_size_confinterval,Jansen_total_order_indices_vs_experiment_size_confinterval,MauntzKucherenko_first_order_indices_vs_experiment_size_confinterval,MauntzKucherenko_total_order_indices_vs_experiment_size_confinterval,Martinez_first_order_indices_vs_experiment_size_confinterval,Martinez_total_order_indices_vs_experiment_size_confinterval)
...
def compute_sensitivity_indices_PCE(training_amount, degree):
    ...
    complete_filename = miu.create_pkl_name("PCE_mechanoadaptation_circular" + str(degree), training_amount, folder="")
...
def plot_results_sensitivity_analysis(
    ...
    first_order_indices, total_order_indices, first_order_indices_confidence_errorbar, total_order_indices_confidence_errorbar = get_indices_and_confidence_intervals(type_of_metamodel, training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    )
    # complete_pkl_filename_sensitivy_algo = miu.create_pkl_name_sensitivityalgo(type_of_metamodel + '_mechanoadaptation_circular'
    #     , training_amount, sensitivity_experiment_size, type_of_Sobol_sensitivity_implementation
    # )
    ...
    ax.set_xticks([0, 1, 2])
    ax.set_xticklabels(
        [r"$\overline{\gamma}_A$", r"$\overline{\gamma}_D$", r"$\overline{\gamma}_S$"],
        font=fonts.serif(),
    ...
    filename = (
        ...
        + "_metamodel="
        + type_of_metamodel
        + "_mechanoadaptation_circular_trainingamount="
        + str(training_amount)
        + "_size="
...
computation_time_vs_experiment_size,     createfigure,
    ...
    labels = [ r"$\overline{\gamma}_A$", r"$\overline{\gamma}_D$", r"$\overline{\gamma}_S$"]
    ...
    savefigure.save_as_png(fig_first, 'convergence_firstSobol_mechanoadaptation_circular_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
    savefigure.save_as_png(fig_total, 'convergence_totalSobol_mechanoadaptation_circular_' +  type_of_Sobol_sensitivity_implementation + str(pixels) + "p")
...
def plot_gradient_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_gradient = "sensitivity_analysis_convergence_gradient_mechanoadaptation_circular.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "gradient_firstSobol_Saltelli_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "gradient_totalSobol_Saltelli_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Jansen_first, "gradient_firstSobol_Jansen_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Jansen_total, "gradient_totalSobol_Jansen_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "gradient_firstSobol_MauntzKucherenko_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "gradient_totalSobol_MauntzKucherenko_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Martinez_first, "gradient_firstSobol_Martinez_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Martinez_total, "gradient_totalSobol_Martinez_mechanoadaptation_circular")
...
def plot_confinterval_Sobol_vs_sample_size(sensitivity_experiment_size_list):
    ...
    """
    filename_sensitivity_convergence_confinterval = "sensitivity_analysis_convergence_confinterval_mechanoadaptation_circular.pkl"
    ...
    savefigure.save_as_png(fig_Saltelli_first, "confinterval_firstSobol_Saltelli_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Saltelli_total, "confinterval_totalSobol_Saltelli_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Jansen_first, "confinterval_firstSobol_Jansen_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Jansen_total, "confinterval_totalSobol_Jansen_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_first, "confinterval_firstSobol_MauntzKucherenko_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_MauntzKucherenko_total, "confinterval_totalSobol_MauntzKucherenko_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Martinez_first, "confinterval_firstSobol_Martinez_mechanoadaptation_circular")
    ...
    savefigure.save_as_png(fig_Martinez_total, "confinterval_totalSobol_Martinez_mechanoadaptation_circular")
...
def plot_comparison_indices(
    ...
    palette = [palette_initial[k] for k in range(5, len(palette_initial), 2)]
...
def plot_comparison_indices_piechart(
    ...
    filename = ('sobolindices_Kriging_piechart_mechanoadaptation_circular')
    savefigure.save_as_png(fig, filename + str(pixels) + "p")
...
if __name__ == "__main__":
    ...
    compute_convergence_Sobol_indices(
        ...
        createfigure,
        pixels)
    filename_sensitivity_convergence = "sensitivity_analysis_convergence_mechanoadaptation_circular.pkl"
